...
/**
 * As a secondary resource provider of a primary resource {@code P}, it brings the ability to define this second
 * resource name. Resource names can be later used as resource discriminator to easily setup watchers.
 * @author laurent
 */
